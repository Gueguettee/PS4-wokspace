...
// static uint16_t ADC_val[eNbrOfAN];   // global value to store the ADC1 conversion value
...
void var_adc1Init(adc_args in)
{
	...
	AD1CSSH = 0x0000;       // AN 31-16 not used
	AD1CSSL = 0x00FF;       // AN 0-7 activated and scanned
