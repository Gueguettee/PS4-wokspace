...
/// @note    This function is created to be used by the UARTSend fct and allow
...
/// @param   rxtx The parameter to select if this is the interruption for 
///          reception (eRX) or emission (eTX)
...
/// @param   eUARTx The UART that you want to regsiter
...
/// @note    This function allow to register the UART interrupt routines by 
///          a callback.
