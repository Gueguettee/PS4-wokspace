...
void pwmInit(pwm_t ePWMx, pwmPER_t exPER, pwmMode_t exMode)
{
    ...
    switch(ePWMx)
    {
		...
		case ePWM2:
            ...
            IOCON2bits.PENH = 0;    // PWMxH pin disable
            IOCON2bits.PENL = 0;    // PWMxL pin disable
		...
		case ePWM3:
            ...
            IOCON3bits.PENH = 0;    // PWMxH pin disable
            IOCON3bits.PENL = 0;    // PWMxL pin disable
		...
		case ePWM4:
            ...
            IOCON4bits.PENH = 0;    // PWMxH pin disable
            IOCON4bits.PENL = 0;    // PWMxL pin disable
		...
		case ePWM5:
            ...
            IOCON5bits.PENH = 0;    // PWMxH pin disable
            IOCON5bits.PENL = 0;    // PWMxL pin disable
		...
		case ePWM6:
            ...
            IOCON6bits.PENH = 0;    // PWMxH pin disable
            IOCON6bits.PENL = 0;    // PWMxL pin disable
...
void pwmStepByStepInit(pwm_t ePWMx, pwm_t ePWMx2, uint16_t pwmFreq, pwmPER_t exPER, pwmDirection_t pwmD)
{
    ...
    setPwmDuty(ePWMx, 5000);
    setPwmDuty(ePWMx2, 5000);
    
    setPwmPhase(ePWMx2, 90);  // Phase of 180° for the second ePWM
    ...
    switch(ePWMx)
    {
        case ePWM1:
            ...
            IOCON1bits.POLH = pwmD;    // PWMxH pin is in direction pwmD
            IOCON1bits.POLL = pwmD;    // PWMxL pin is in direction pwmD
            break;
        case ePWM2:
            ...
            IOCON2bits.POLH = pwmD;    // PWMxH pin is in direction pwmD
            IOCON1bits.POLL = pwmD;    // PWMxL pin is in direction pwmD
            break;
        case ePWM3:
            ...
            IOCON3bits.POLH = pwmD;    // PWMxH pin is in direction pwmD
            IOCON1bits.POLL = pwmD;    // PWMxL pin is in direction pwmD
            break;
        case ePWM4:
            ...
            IOCON4bits.POLH = pwmD;    // PWMxH pin is in direction pwmD
            IOCON1bits.POLL = pwmD;    // PWMxL pin is in direction pwmD
            break;
        case ePWM5:
            ...
            IOCON5bits.POLH = pwmD;    // PWMxH pin is in direction pwmD
            IOCON1bits.POLL = pwmD;    // PWMxL pin is in direction pwmD
            break;
        case ePWM6:
            ...
            IOCON6bits.POLH = pwmD;    // PWMxH pin is in direction pwmD
            IOCON1bits.POLL = pwmD;    // PWMxL pin is in direction pwmD
            break;
        default:
            break;
