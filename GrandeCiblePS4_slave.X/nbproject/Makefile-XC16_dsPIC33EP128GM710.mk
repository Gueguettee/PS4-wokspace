...
${OBJECTDIR}/src/mainSlave.o: src/mainSlave.c  .generated_files/flags/XC16_dsPIC33EP128GM710/e81d0f98953dbefdf72d1cdc5414f1a00a1d07f1 .generated_files/flags/XC16_dsPIC33EP128GM710/24e18da1c422b499c691c65d8515f474e43e977d
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/mainSlave.o.d 
	@${RM} ${OBJECTDIR}/src/mainSlave.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/mainSlave.c  -o ${OBJECTDIR}/src/mainSlave.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/src/mainSlave.o.d"      -g -D__DEBUG   -mno-eds-warn  -omf=elf -DXPRJ_XC16_dsPIC33EP128GM710=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -I"src" -I"header" -msmart-io=1 -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
...
${OBJECTDIR}/src/mainSlave.o: src/mainSlave.c  .generated_files/flags/XC16_dsPIC33EP128GM710/d7b1c973c6e9b8f4e8933b08a8d742a22e4bc691 .generated_files/flags/XC16_dsPIC33EP128GM710/24e18da1c422b499c691c65d8515f474e43e977d
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/mainSlave.o.d 
	@${RM} ${OBJECTDIR}/src/mainSlave.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/mainSlave.c  -o ${OBJECTDIR}/src/mainSlave.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/src/mainSlave.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_XC16_dsPIC33EP128GM710=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -I"src" -I"header" -msmart-io=1 -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
